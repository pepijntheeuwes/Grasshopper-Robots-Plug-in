...
public class ProgramTarget
{
    ...
    public bool IsPMotion => (Target as CartesianTarget).Motion == Motions.Process;
    ...
    public Target Lerp(ProgramTarget prevTarget, RobotSystem robot, double t, double start, double end)
    {
        ...
        else if (IsPMotion)
        {
            ...
            var target = new CartesianTarget(plane, Target, prevTarget.Kinematics.Configuration, Motions.Process, external);
            target.pTarget = true;
